...
- **[AutoRecommendation/](AutoRecommendation/)** — Standalone harness for definity-app's auto-recommendations agent (`auto-recommendations-agent` branch) with Athena as the data source, plus saved run results ([README inside](AutoRecommendation/README.md)).
