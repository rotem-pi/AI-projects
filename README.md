...
- **[cost-optimizer/](cost-optimizer/)** — Research and validation for Spark/Databricks auto-tuning: design docs, offline scripts, notebooks, and case-study data ([README inside](cost-optimizer/README.md)).
